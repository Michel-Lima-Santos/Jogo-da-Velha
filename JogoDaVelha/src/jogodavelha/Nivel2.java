...
public class Nivel2 implements Computador // Classe Filha "Nivel2" pertencente à Classe Mãe "Computador" que representará a dificuldade "Normal"
{
	...
	// No segundo nível de dificuldade, o Computador jogará de acordo com o primeiro nível de dificuldade, porém irá verificar as colunas (verticalmente) e caso hajam 2 posições ocupadas verticalmente em sequência, o
